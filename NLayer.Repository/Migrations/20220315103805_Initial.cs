    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2022, 3, 15, 13, 38, 5, 185, DateTimeKind.Local).AddTicks(2031), "Kurşun Kalem", 5m, 20, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdateDate" },
                values: new object[] { 2, 2, new DateTime(2022, 3, 15, 13, 38, 5, 185, DateTimeKind.Local).AddTicks(2041), "Güzel Yazı Defteri", 15m, 10, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdateDate" },
                values: new object[] { 3, 3, new DateTime(2022, 3, 15, 13, 38, 5, 185, DateTimeKind.Local).AddTicks(2043), "Almanca Dil Bilgisi Kitabı", 90m, 10, null });
            ...
            migrationBuilder.InsertData(
                table: "ProductFeature",
                columns: new[] { "Id", "Color", "Height", "ProductId", "Width" },
                values: new object[] { 2, "Mavi", 200, 2, 50 });
